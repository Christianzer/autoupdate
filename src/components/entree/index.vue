...
export default {
  ...
  methods: {
    ...
    async dowloadFile(id){
      let api = 'http://gcaisse-backend.sodenci.com/api/dowload/'+id
      axios({
        url: api,
        method: 'GET',
        responseType: 'blob',
    ...
    async fetchclients(){
      this.loader = false
      let api = 'http://gcaisse-backend.sodenci.com/api/listes_entre'
    ...
    openModalJustif(id){
      let api = 'http://gcaisse-backend.sodenci.com/api/listes_justif/'+id
